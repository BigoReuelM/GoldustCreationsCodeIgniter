        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="form-group">
              ...
              if ($transactionStatus === "finished" || $transactionStatus === "cancelled") {
                ?>
                <input type="text" id="contactNumber" name="contactNumber" class="form-control" placeholder="<?php echo $details->contactNumber ?>" disabled>
              <?php } else { ?>
            ...
            <div class="form-group">
              ...
              if ($transactionStatus === "finished" || $transactionStatus === "cancelled") {
                ?>
                <input type="text" id="address" name="address" class="form-control" placeholder="<?php echo $details->homeAddress ?>" value="" disabled>
              <?php } else { ?>
            ...
            <div class="form-group">
              ...
              if ($transactionStatus === "finished" || $transactionStatus === "cancelled") {
                ?>
                <input type="text" id="yNs" name="yNs" class="form-control" placeholder="<?php echo $details->yearAndSection ?>" value="" disabled>
              <?php } else { ?>
            ...
            <div class="form-group">
              ...
              if ($transactionStatus === "finished" || $transactionStatus === "cancelled") {
                ?>
                <input type="text" id="school" name="school" class="form-control" placeholder="<?php echo $details->school ?>" value="" disabled>
              <?php } else { ?>
            ...
            <div class="form-group">
              ...
              if ($transactionStatus === "finished" || $transactionStatus === "cancelled") {
                ?>
                <input type="text" id="idType" name="idType" class="form-control" placeholder="<?php echo $details->IDType ?>" value="" disabled>
              <?php } else { ?>
          ...
          <div class="col-lg-6">             
            <div class="form-group">
              ...
              if ($transactionStatus === "finished" || $transactionStatus === "cancelled") {
                ?>
                <input type="text" id="depositAmt" name="depositAmt" class="form-control" placeholder="<?php echo $formatedDepositedAmount ?>" value="" disabled>
              <?php } else { ?>
            ...
            <div class="form-group">
              ...
              <?php 
              if ($transactionStatus === "finished" || $transactionStatus === "cancelled") { ?>
                <select class="form-control" name="handler" disabled>
