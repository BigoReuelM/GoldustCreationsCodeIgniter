...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 12, 2018 at 06:02 AM
...
CREATE TABLE IF NOT EXISTS `appointments` (
  ...
  KEY `fk_app_transactionID` (`transactionID`)
...
(0000003, 0000009, NULL, '2018-05-16', '00:00:00', 'Qrvr', 0001, 'ongoing'),
(0000004, NULL, 0000001, '2018-05-29', '01:06:00', 'Asfasf', 0001, 'finished');
...
(0000002, 'Michelle', 'Hermansen', 'Ostergaard', '2018-04-02', '09919902873'),
(0000003, 'Anton', 'Karlsen', 'Poulsen', '2018-04-04', '09918290387'),
(0000004, 'Johan', 'Schultz', 'Jeppesen', '2018-04-07', '09918827739'),
(0000005, 'Peter', 'Olsen', 'Svendsen', '2018-04-01', '09991887267'),
(0000006, 'Benjamin', 'Ravn', 'Bruun', '2018-04-09', '09128374657'),
(0000007, 'sfdsf', 'dsfsdf', 'sdfsdff', '2018-05-17', '6346346'),
(0000008, 'aaa', 'aaa', 'aa', '2018-05-10', '2222');
...
(0000036, 'ferrero', 'yellow', 'trinkets', 0000003),
(0000037, 'decoe check', 'asasjk', 'utensils', 0000004);
...
(0000032, 'Anime', 'white', 'gown', 0000003),
(0000033, 'design check', 'sasa', 'suit', 0000004);
...
(0000002, 'Irene Ostergaard Birthday', 0000002, 'Irene Ostergaard', '2018-04-06', 0, 'Km 6, La Trinidad, Benguet', 'Birthday', '10:00:00', 'Red', 0005, 1650, 'cancelled', 'semi-package', '2018-04-02', '0.00', '2018-05-22', '2018-05-22', NULL, NULL, NULL),
(0000003, 'Anton-Damgaard Nuptial', 0000003, 'Anton-Damgaard', '2018-04-18', 0, 'Baguio Cathedral, Baguio City', 'Wedding', '13:00:00', 'White', 0006, NULL, 'finished', 'semi-package', '2018-04-05', NULL, NULL, NULL, NULL, '2018-05-22', NULL),
(0000004, 'Ella Castro&#039;s Debut', 0000003, 'Ella Castro', '2018-04-12', 0, 'Bakakeng Sur, Baguio City', 'Birthday', '14:00:00', 'Blue', 0007, NULL, 'on-going', 'semi-package', '2018-04-09', NULL, NULL, NULL, NULL, NULL, 0000004),
(0000005, '11th ABC Inc. Convention', 0000003, 'ABC Inc.', '2018-04-18', 0, 'Easter Gym, Easter College, Baguio City', 'Conference', '10:00:00', NULL, 0005, 5000, 'on-going', 'semi-package', '2018-04-03', NULL, NULL, NULL, NULL, NULL, 0000003),
(0000006, 'Sports Fest', 0000003, 'BSU', '2018-04-17', 0, 'BSU, La Trinidad, Benguet', 'Sports Fest', '09:00:00', NULL, 0008, NULL, 'on-going', 'semi-package', '2018-04-09', NULL, NULL, NULL, NULL, NULL, 0000003),
(0000007, 'Michael Birthday', 0000002, 'Michael Ostergaard', '2018-07-25', 3, NULL, NULL, '10:00:00', NULL, 0005, NULL, 'finished', NULL, '2018-05-07', '0.00', '2018-05-22', '2018-05-22', '2018-05-22', '2019-11-21', NULL),
(0000008, 'YMCA Staff Seminar', 0000002, 'YMCA', '2018-05-15', 3, NULL, NULL, '10:00:00', NULL, 0005, NULL, 'on-going', NULL, '2018-05-07', NULL, NULL, NULL, NULL, NULL, 0000003),
(0000009, 'Iiii', 0000008, 'Ijiiii', '2017-05-18', 9, NULL, NULL, '00:00:00', NULL, 0005, 5000, 'on-going', NULL, '2017-04-22', NULL, NULL, NULL, NULL, NULL, 0000001);
...
INSERT INTO `expenses` (`expensesID`, `expensesName`, `expensesAmount`, `expenseDate`, `receiptNum`, `employeeID`) VALUES
(0000001, 'Fgsfd', '546.00', '2018-05-22', '435354frfs', 0001);
...
INSERT INTO `payments` (`paymentID`, `clientID`, `eventID`, `transactionID`, `employeeID`, `date`, `time`, `amount`) VALUES
(0000001, 0000008, 0000009, NULL, 0001, '2018-05-22', '11:00:00', '500.00'),
(0000002, 0000008, 0000009, NULL, 0001, '2018-05-23', '06:00:00', '500.00'),
(0000003, 0000003, 0000005, NULL, 0009, '2018-05-16', '06:00:00', '500.00'),
(0000004, 0000008, NULL, 0000001, 0001, '2018-06-08', '20:12:00', '888.00'),
(0000005, 0000008, NULL, 0000001, 0001, '2018-06-08', '20:13:00', '19112.00');
...
INSERT INTO `theme` (`themeID`, `themeName`, `themeDesc`) VALUES
(0000001, 'The,ememe', 'Kkk'),
(0000002, 'Asdasd', 'Adsdasdas'),
(0000003, 'Sample', 'Sample Sample'),
(0000004, 'Check', 'Check\r\n');
...
INSERT INTO `transactiondetails` (`transactionID`, `serviceID`, `quantity`, `amount`) VALUES
(0000001, 0000003, 0, 20000);
...
INSERT INTO `transactions` (`transactionID`, `clientID`, `time`, `dateAvail`, `homeAddress`, `IDType`, `yearAndSection`, `school`, `depositAmt`, `employeeID`, `totalAmount`, `transactionstatus`, `cancelledDate`, `finishDate`, `refundAmt`) VALUES
(0000001, 0000008, '15:07:00', '2018-05-17', NULL, NULL, NULL, NULL, NULL, 0010, '20000.00', 'finished', NULL, '2018-06-08', NULL),
(0000002, 0000008, '23:23:00', '2018-06-06', NULL, NULL, NULL, NULL, NULL, 0006, NULL, 'cancelled', '2018-06-06', NULL, NULL);
...
ALTER TABLE `appointments`
  ...
  ADD CONSTRAINT `fk_app_transactionID` FOREIGN KEY (`transactionID`) REFERENCES `transactions` (`transactionID`);

--
-- Constraints for table `decors`
--
ALTER TABLE `decors`
  ADD CONSTRAINT `dec_themeID` FOREIGN KEY (`themeID`) REFERENCES `theme` (`themeID`);

--
-- Constraints for table `designs`
--
ALTER TABLE `designs`
  ADD CONSTRAINT `des_themeID` FOREIGN KEY (`themeID`) REFERENCES `theme` (`themeID`);
...
--
-- Constraints for table `entouragedetails`
--
ALTER TABLE `entouragedetails`
  ADD CONSTRAINT `fk_etd_designID` FOREIGN KEY (`designID`) REFERENCES `designs` (`designID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_etd_entourageID` FOREIGN KEY (`entourageID`) REFERENCES `entourage` (`entourageID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `transactiondecors`
  ...
  ADD CONSTRAINT `fk_tde_transactionID` FOREIGN KEY (`transactionID`) REFERENCES `transactions` (`transactionID`);
